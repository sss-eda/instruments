...
func init() {
	Event = graphql.NewObject(graphql.ObjectConfig{
		Name: "Event",
	...
	InstrumentEventEdge = graphql.NewObject(graphql.ObjectConfig{
	...
	InstrumentEventConnection = graphql.NewObject(graphql.ObjectConfig{
